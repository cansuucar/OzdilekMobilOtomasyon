...
public class BaseTest {  //Telefonları ayaga kaldırdıgımız yer

    protected static AppiumDriver<MobileElement> appiumDriver; //Driveri setledik
    protected boolean localAndroid = true;  //ios android ayrımını yaptık


@BeforeScenario  //testten ünce hazırlık aşaması before senaryoda tutulur
public void Education() throws MalformedURLException {
    ...
    public void afterScenario() {
        if(appiumDriver != null)
            appiumDriver.quit();  //driveri kapattık
    }
